package com.oreillyauto.widgetmanager.config;
...
@EnableJpaRepositories(basePackages = "com.oreillyauto.widgetmanager.dao", entityManagerFactoryRef = "embeddedEntityManagerFactory",
...
public class SpringJDBCConfiguration {
    ...
    public DataSource dataSource() {
        ...
        EmbeddedDatabase db = builder.setType(EmbeddedDatabaseType.DERBY).addScript("widgets.sql").build();
        return db;
    }
